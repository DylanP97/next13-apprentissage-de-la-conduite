...
type BasicCardType = "user" | "createQuestion" | "question" | "article";
...
interface BasicCardProps {
  ...
  toggleMethod2?: (id: string, isAdmin: boolean) => void;
...
const BasicCard: React.FC<BasicCardProps> = ({
  ...
  if (type === "user") {
    ...
    return (
      <div
        className="blog-card new-question"
        data-testid="BasicCard-createQuestion"
