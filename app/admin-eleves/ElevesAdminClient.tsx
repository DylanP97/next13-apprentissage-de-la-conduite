...
const ElevesAdminClient: React.FC<ElevesAdminClientProps> = ({ users }) => {
    ...
    axios
      ...
      .then(() => {
        ...
        if (userIndex !== -1) {
          ...
          const newUpdatedUsers = updatedUsers.filter(
  ...
  return (
    <div className="home-container">
      ...
      <p>
        Ici gérer les inscriptions, les rôles ou supprimer des comptes
        d&apos;utilisateurs.
      </p>
      <hr />
      <br />
