...
const ArticleAdminClient: React.FC<ArticleAdminClientProps> = ({ blogs }) => {
  ...
  return (
    <div className="home-container">
      ...
      <p>
        Ici changer la visibilité, jeter un oeil, modifier ou supprimer
        l&apos;un de vos articles.
      </p>
      <p>
        Nombre total d&apos;articles actuellement : {blogsData?.length || 0}
      </p>
      <p>
        Nombre d&apos;articles visibles aux élèves :{" "}
            ...
            {Object.values(blogsData).map((blog: any) => {
              return (
                <BasicCard
                  ...
                  data={blog}
                  type="article"
                  toggleMethod={togglePublish}
                  deleteMethod={deleteArticle}
                />
              );
            })}
          </div>
